...
import { CalculosPatron2 } from '../../utils/calculos_version_2';

@Component({
  selector: 'logistica-patron-version-2',
  templateUrl: './logistica_patron_version_2.component.html',
  styleUrls: ['./logistica_patron_version_2.component.scss']
})
export class LogisticaPatronVersion2Component {
  ...
  calcular() {
    const calculo = new CalculosPatron2();
